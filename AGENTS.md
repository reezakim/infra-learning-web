...
## Tentang Project
Portfolio website Reza Hakim Arafah (Infrastructure/DevOps track) — static site 
bertema glassmorphism, isi: Hero, About, Learning Lab, Projects, Contact.

## Environment
- Stack: HTML, CSS (Tailwind), vanilla JS
- Server: Ubuntu, Node.js BELUM terinstall — belum ada environment testing 
  untuk bagian backend (server.js/admin.js). Anggap semua perubahan backend 
  sifatnya "belum bisa divalidasi jalan", jangan klaim "sudah tested".
- Scope kerja: HANYA di dalam /home/reza/workspace/ai-labs — jangan sentuh 
